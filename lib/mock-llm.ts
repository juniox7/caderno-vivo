...
export async function gerarAtividadeDiariaMock(): Promise<AtividadeDiaria> {
  ...
  const atividades: AtividadeDiaria[] = [
    ...
    {
      id: 'daily-4',
      titulo: '🔎 Detetive Linguístico',
      descricao: 'Encontre a palavra intrusa!',
      tipo: 'quebra-cabeca',
      conteudo: 'Qual dessas palavras NÃO pertence ao grupo das outras? (Baleia, Golfinho, Tubarão, Peixe-boi)',
      opcoes: ['Baleia', 'Golfinho', 'Tubarão', 'Peixe-boi'],
      respostaCorreta: 'Tubarão',
      resposta: 'Tubarão! (Ele é um peixe, os outros são mamíferos marinhos).',
      dica: 'Pense em como eles respiram ou como alimentam seus filhotes.',
    },
    {
      id: 'daily-5',
      titulo: '🚀 Matemática Espacial',
      descricao: 'Contagem de meteoros!',
      tipo: 'desafio',
      conteudo: 'Um astronauta contou 12 meteoros na segunda-feira e o triplo disso na terça-feira. Quantos meteoros ele viu ao todo nesses dois dias?',
      opcoes: ['36 meteoros', '40 meteoros', '48 meteoros', '24 meteoros'],
      respostaCorreta: '48 meteoros',
      resposta: '48 meteoros (12 + 36 = 48).',
      dica: 'Primeiro ache o triplo de 12. Depois some os dois!',
    },
    {
      id: 'daily-6',
      titulo: '🌱 Mistério Botânico',
      descricao: 'Desvende o segredo das plantas.',
      tipo: 'curiosidade',
      conteudo: 'Existe uma planta que fecha suas folhas quando tocada. Como ela é popularmente conhecida?',
      opcoes: ['Girassol', 'Dormideira', 'Samambaia', 'Suculenta'],
      respostaCorreta: 'Dormideira',
      resposta: 'Dormideira (Mimosa pudica).',
      dica: 'Pense em alguém que está com sono!',
    },
  ];
