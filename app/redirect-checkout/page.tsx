...
function CheckoutLogic() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-surface-50 dark:bg-[#0f172a] text-surface-600">
      ...
      <h2 className="text-xl font-bold" style={{ fontFamily: 'var(--font-baloo)' }}>Redirecionando para o Pagamento Seguro...</h2>
      <p className="text-sm text-surface-400 mt-2">Aguarde um momento enquanto preparamos seu link.</p>
    </div>
  );
}
